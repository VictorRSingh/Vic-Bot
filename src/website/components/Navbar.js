...
export default function Navbar(props) {
    ...
    return(<>
        <div style={{backgroundColor: `${color}`}} className='fixed left-0 top-0 w-full z-10 ease-in duration-300'>
            ...
            <Link href='/'>
                <h1 style={{color: `${textColor}`}} className='font-bold text-4xl'>Victor Singh</h1>
                </Link>
            <ul style={{color: `${textColor}`}} className='hidden sm:flex'>
                    <li className='p-4'><Link href='/'>Home</Link></li>
                    <li className='p-4'><Link href='/projects'>Projects</Link></li>
                    <li className='p-4'><Link href='/resume'>Interactive Resume</Link></li>
                ...
                {/* Mobile Menu */}
                <div style={{color: `${textColor}`}} className={nav ? 'sm:hidden absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center w-full h-screen bg-black text-center ease-in duration-300' : 'sm:hidden absolute top-0 left-[-100%] right-0 bottom-0 flex justify-center items-center w-full h-screen bg-black text-center ease-in duration-300'}>
                <ul>
                    <li className='p-4 text-4xl hover:text-gray-500'><Link href='/'>Home</Link></li>
                    <li className='p-4 text-4xl hover:text-gray-500'><Link href='/projects'>Projects</Link></li>
                    <li className='p-4 text-4xl hover:text-gray-500'><Link href='/resume'>Interactive Resume</Link></li>
