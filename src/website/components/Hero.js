...
export default function Hero({heading, message}) {
    return(<>
        <div className="flex items-center justify-center min-h-screen mb-12 bg-fixed bg-center bg-cover">
            {/* Overlay */}
            ...
            <div className="p-5 text-white z-[2] mt-[-5rem]">
                ...
                <button className="px-8 py-2 text-blue-500 border">Learn More</button>
            </div>
        </div>
    </>)
}